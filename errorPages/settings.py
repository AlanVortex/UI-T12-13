...
SECRET_KEY = 'django-insecure-4#-2u+d#8+nyor8rd(p!z8vj6i-%2_b5wi)m6e+8i*jdmkrr%#'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTIFICATION_CLASSES':(
        'rest_framework_simplejwt.authentication.JWTAuthenticacion',
    ),
}
...
LOGOUT_REDIRECT_URL = '/users/login/' # Dónde irán los usuarios tras cerrar sesión
